...
class robot:
    ...
    def sense(self): #do not change the name of this function
        ...
        for i in range(len(landmarks)):     
            #atan = atan2(sqrt((self.y  - landmarks[i][0])**2) , sqrt((self.x - landmarks[i][1])**2)) + pi
...
##
##print 'should print [6.004885648174475, 3.7295952571373605, 1.9295669970654687, 0.8519663271732721]'
